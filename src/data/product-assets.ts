...
export type ProductImageSet = {
  ...
  slug: string;
  name: string;
  type: "Dehydrated" | "Krunch" | "Meal Booster" | "Peanut Butter" | "Bed" | "T-Shirt";
  pet: "dog" | "cat";
  category: "dog-food" | "beds" | "tshirt";
  price: number;
  mrp: number;
  front: string;
  back: string;
...
/** T-Shirts — card uses the gr / preferred shot per color. */
export const TSHIRT_PRODUCTS: ProductImageSet[] = [
  {
    key: "black",
    fileKey: "tshirt_black",
    ...
    both: teeBlackGr,
    hasBothFile: false,
    gallery: [teeBlackGr, teeBlack],
    customFiles: {
      "tshirt_black.jpg": teeBlackGr,
      "tshirt_black_alt.jpg": teeBlack,
      "black gr.jpg": teeBlackGr,
      "black .jpg": teeBlack,
    },
    cardImageFile: "tshirt_black.jpg",
  },
  {
    key: "blue",
    fileKey: "tshirt_blue",
    slug: "nuzz-tshirt-blue",
    name: "The Nuzz Story T-Shirt — Blue",
    type: "T-Shirt",
    pet: "dog",
    category: "tshirt",
    price: 699,
    ...
    customFiles: {
      "tshirt_blue.jpg": teeBlueAlt,
      "tshirt_blue_alt.jpg": teeBlueFront,
      "blue gr f.jpg": teeBlueAlt,
      "blue f gr.jpg": teeBlueFront,
    },
    cardImageFile: "tshirt_blue.jpg",
  },
  {
    key: "chaos-red",
    fileKey: "tshirt_chaos_red",
    slug: "nuzz-tshirt-built-for-chaos-red",
    name: "Built for Chaos T-Shirt — Red",
    type: "T-Shirt",
    pet: "dog",
    category: "tshirt",
    price: 749,
    ...
    gallery: [teeChaosRed],
    customFiles: {
      "tshirt_chaos_red.jpg": teeChaosRed,
      "built for choas red.jpg": teeChaosRed,
    },
    cardImageFile: "tshirt_chaos_red.jpg",
  },
  {
    key: "maroon",
    fileKey: "tshirt_maroon",
    ...
    both: teeMaroonGr,
    hasBothFile: false,
    gallery: [teeMaroonGr, teeMaroon],
    customFiles: {
      "tshirt_maroon.jpg": teeMaroonGr,
      "tshirt_maroon_alt.jpg": teeMaroon,
      "marhoon gr w.jpg": teeMaroonGr,
      "marhoon.jpg": teeMaroon,
    },
    cardImageFile: "tshirt_maroon.jpg",
  },
  {
    key: "pink",
    fileKey: "tshirt_pink",
    slug: "nuzz-tshirt-pink",
    name: "The Nuzz Story T-Shirt — Pink",
    type: "T-Shirt",
    pet: "dog",
    category: "tshirt",
    price: 699,
    ...
    customFiles: {
      "tshirt_pink.jpg": teePinkGr,
      "tshirt_pink_alt.jpg": teePinkFront,
      "pink gr.jpg": teePinkGr,
      "pink front gr.jpg": teePinkFront,
    },
    cardImageFile: "tshirt_pink.jpg",
  },
  {
    key: "white",
    fileKey: "tshirt_white",
    ...
    both: teeWhiteGr,
    hasBothFile: false,
    gallery: [teeWhiteGr, teeWhite],
    customFiles: {
      "tshirt_white.jpg": teeWhiteGr,
      "tshirt_white_alt.jpg": teeWhite,
      "white gr.jpg": teeWhiteGr,
      "white.jpg": teeWhite,
    },
    cardImageFile: "tshirt_white.jpg",
  },
];
